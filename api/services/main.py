...
mongo_user = json.loads(os.getenv('MONGO_USER'))['MONGO_USER']
mongo_pass = json.loads(os.getenv('MONGO_PASSWORD'))['MONGO_PASSWORD']
...
# try:
#     mongodb_secrets = json.loads(client.get_secret_value(SecretId='deepersleeper/mongodb'))
# except ClientError as e:
#     raise e

# mongo_user = mongodb_secrets['MONGO_USER']
# mongo_pass = mongodb_secrets['MONGO_PASSWORD']
